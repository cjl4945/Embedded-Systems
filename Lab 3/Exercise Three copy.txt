...
zero3p		
			MOVS	R1,#0
			B		zero7q
cont3p		LSLS	R1,#24				;shift 3p to most significant bit
			LSLS	R2,R2,#MUL8			;8Q
			;
	        LDR		R7,=Q
			LDR		R7,[R7,#0]
			SUBS	R2,R2,R7			;8Q-Q = 7Q
check7q		CMP		R2,#127
			BGT		zero7q
			CMP		R2,R3
			BLT		zero7q
...
P			SPACE 	4	;word variable P gets 4 bytes of memory
Q			SPACE	4	;word variable Q gets 4 bytes of memory
F			SPACE	4	;word variable F gets 4 bytes of memory
G			SPACE	4	;word variable G gets 4 bytes of memory
Result 		SPACE	4	;word variable Result gets 4 bytes of memory
;>>>>>   end variables here <<<<<
            END
